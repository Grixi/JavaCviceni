...
public class Sifra2{
    ...
    public void zadej(Scanner sc, Sifra2 s){
        System.out.println("Zadej slovo");  
        input = sc.nextLine(); 
    }

    public void zjistiDelku(Sifra2 s){
        delka = input.length();
    }

    //prvni pismeno je 0
    public void zjistiPismeno(Sifra2 s){
